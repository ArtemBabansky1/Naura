...
import MeetsCta from "./MeetsCta"
import MeetsFooter from "./MeetsFooter"
import "./MeetsPage.css"
import { CardHeader } from "../../components/CardDesign/CardDesign"
import "./MeetsRedesign.css"
...
export const MeetsPage = () => {
  ...
  return (
    ...
    <div className="bc2-page card-site meets-page meets-redesign" data-product="meets" style={PRODUCT_THEME_STYLES.meets} key={i18n.language}>
