...
const BASE_SPEED = 2.59 // %/s — idle drift, ~19s per loop (1.8 → +20% → +20%)
...
export default function MeetsMarquee() {
  ...
  // 1 = leftwards (scrolling down), -1 = rightwards; keeps the last scroll
  // direction while idle. Starts rightwards, so the strip opens on "1 на 1"
  // and carries it to the right before any scroll input arrives.
