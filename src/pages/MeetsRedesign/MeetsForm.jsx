...
import conferencePhoto from "../../assets/meets-redesign/community-conference.webp"
    ...
    <section id="meets-form" data-section="meets-form" className="meets-form section">
      <div className="container">
        <div className="meets-form__panel">
          <picture><img src={conferencePhoto} className="meets-form__bg" alt="" width="1672" height="941" loading="lazy" decoding="async" /></picture>
