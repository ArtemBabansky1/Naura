...
// Naura brand mark — inline so it ships with the JS, no extra request. Mirrors
// the footer logo shape; its own gradient id avoids clashing with the footer's.
function NauraMark() {
  return (
    <svg className="mobile-nav__logo-img" width="364" height="162" viewBox="0 0 364 162"
      fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Naura" focusable="false">
      <path
        ...
        fill="url(#mobilenav-logo-grad)"
      />
      <defs>
        <linearGradient id="mobilenav-logo-grad" x1="182" y1="0" x2="182" y2="146.195"
              ...
              >
                <div className="mobile-nav__top">
                  <a
                    ...
                    onClick={close}
                    aria-label={t('nav.home', 'Naura home')}
                  >
                    <NauraMark />
                  </a>
