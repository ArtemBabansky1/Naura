    ...
    <section id="pricing" data-section="pricing" className="pricing-section section">
      <motion.div className="container" {...sectionMotion}>
        <motion.header className="pricing-header" variants={fadeUp}>
          ...
          <RevealTitle as="h2" className="pricing-header__title text-h2" text={t('headline')} />
          <RevealCopy as="p" className="pricing-header__beta text-body" delay={0.12}>{t('betaBadge')}</RevealCopy>
        </motion.header>
