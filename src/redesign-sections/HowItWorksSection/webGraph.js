...
// Numeric colors are needed by lerpHex; values mirror the digital-card tokens.
const ACCENT = PRODUCT_COLORS.crm.accent
const GRAY = '#777671'
...
const COL_COLLEAGUES = PRODUCT_COLORS.crm.accent
const COL_FAMILY = '#66769b'
const COL_FRIENDS = '#ad6248'
const COL_NEIGHBORS = '#a8aa9c'
